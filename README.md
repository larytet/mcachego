...
The pool Alloc()/Free() API operates with pointers to the blocks (at this point Go crowd runs away crying to things like [Patric's go-cache](https://github.com/patrickmn/go-cache)).
